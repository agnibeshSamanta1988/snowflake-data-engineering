...
-- Add "Snowflake Public Data (Free)" from Snowflake Marketplace
-- once you add it it will create a database SNOWFLAKE_PUBLIC_DATA_FREE
-- Here Cybersyn Financial & Economic data will be used to create app
...
-- Creates a table tracking average annual wages and CPI (Consumer Price Index) for the USA, between 2012 and 2022
...
SELECT * FROM annual_wages_cpi_usa limit 10;
SELECT * FROM monthly_cpi_usa limit 10;
