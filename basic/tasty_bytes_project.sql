...
WHERE RETENTION_TIME IS NOT NULL;

SHOW TABLES;

---> set the data retention time to 90 days
ALTER TABLE tasty_bytes.raw_pos.country SET DATA_RETENTION_TIME_IN_DAYS = 90;

---> set the data retention time to 1 day
ALTER TABLE tasty_bytes.raw_pos.country SET DATA_RETENTION_TIME_IN_DAYS = 1;
...
SELECT * FROM tasty_bytes.raw_pos.truck_dev
AT(TIMESTAMP => '2025-12-29 08:35:31.630 -0800'::TIMESTAMP_LTZ);
