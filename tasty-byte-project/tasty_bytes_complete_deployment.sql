 ...
 * 
 * Usage: Replace {{env}} with your environment prefix (e.g., DEV, PROD, TEST)
...
CREATE OR REPLACE STREAM {{env}}_tasty_bytes.raw_pos.order_header_stream 
   ON TABLE {{env}}_tasty_bytes.raw_pos.order_header;
...
FROM {{env}}_tasty_bytes.harmonized.orders_v o;
 ...
 * 
 * Next Steps:
 *   1. Replace {{env}} with your environment prefix (e.g., DEV, PROD)
